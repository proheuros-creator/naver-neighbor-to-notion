...
// [수정] 타임아웃 시간을 2분(120,000ms)으로 설정하여 쉽게 끊기지 않도록 함
...
// [수정] retries 기본값 3 -> 5회로 증가
async function findExistingPageWithRetry(uniqueId, retries = 5) {
